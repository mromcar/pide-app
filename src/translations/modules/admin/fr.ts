...
export const adminFr: EstablishmentAdminTranslations = {
  dashboard: {
    ...
    manageMenuDesc: 'Modifier les catégories, produits et prix',
    manageTeam: 'Gérer l\'équipe',
    manageTeamDesc: 'Administrer les employés et permissions',
    ...
    qrCodeDesc: 'Partagez ce lien ou code QR avec vos clients pour accéder au menu',
    menuUrl: 'URL du menu',
