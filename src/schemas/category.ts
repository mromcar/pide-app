...
export const categoryTranslationSchema = z.object({
  ...
  // description: optionalString, // Si CategoryTranslation tuviera descripción
});
...
export const updateCategorySchema = createCategorySchema.partial().extend({
  ...
  // Podría ser reemplazar todas, o tener un esquema más complejo para añadir/modificar/eliminar.
